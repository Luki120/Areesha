...
protocol TopRatedTVShowsCollectionViewCellDelegate: AnyObject {
...
class TopRatedTVShowsCollectionViewCell: UICollectionViewCell {
	...
	weak var delegate: TopRatedTVShowsCollectionViewCellDelegate?
...
extension TopRatedTVShowsCollectionViewCell: TVShowListViewViewModelDelegate {
	...
	func didSelect(tvShow: TVShow) {
		delegate?.topRatedTVShowsCollectionViewCell(self, didSelect: tvShow)
	}
