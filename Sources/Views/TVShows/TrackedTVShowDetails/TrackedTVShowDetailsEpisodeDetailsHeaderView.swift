...
final class TrackedTVShowDetailsEpisodeDetailsHeaderView: BaseHeaderView {
	...
	func configure(with viewModel: TrackedTVShowDetailsEpisodeDetailsHeaderViewViewModel) {
