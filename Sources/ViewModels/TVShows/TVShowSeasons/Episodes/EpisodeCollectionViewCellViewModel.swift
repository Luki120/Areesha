...
/// View model class for EpisodeCollectionViewCell
final class EpisodeCollectionViewCellViewModel: Hashable {
	...
	static func == (lhs: EpisodeCollectionViewCellViewModel, rhs: EpisodeCollectionViewCellViewModel) -> Bool {
